...
function on_success(position){
	...
	var map_str = "http://maps.googleapis.com/maps/api/staticmap?"+"center="+position.coords.latitude+", "+ position.coords.longitute+"&zoom=4&size=400x300&maptype=hybrid&key=AIzaSyA-8hlvciV9gfdBvgLtaRytf8mb4vuLrtU";
