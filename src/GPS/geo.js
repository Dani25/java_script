...
function on_success(position){
	...
	var map_str = "https://maps.googleapis.com/maps/api/staticmap?center="+position.coords.latitude+","+ position.coords.longitute+"&zoom=10&size=600x300&key=AIzaSyA-8hlvciV9gfdBvgLtaRytf8mb4vuLrtU";
